...
def get_per_animal_sliceTCA_reconstruction_MSE_kmean(animal_model, tensor_for_animal, residual_activity_dict_SST, animal_id, max_clusters=12, display=False):
    ...
    for clusters_chosen in range(2, max_clusters):
        ...
        animal_X_pca_dict[f"animal_{animal_id}"] = X_pca
...
if __name__ == "__main__":
    ...
    save_dir = fr"/scratch/msf157/data/ca1_data2/animal_EC_model_ranks{ranks}_umap_contig_x00"
