...
def plot_et_is(x_arr_int, params, title="Jeff Model Fit Jeff Data"):
    et_time_1000_dict = {}
...
def data_over_experiment(cleaned_data_dict, params, title=None):
...
def main():
    ...
    plot_et_is(x_arr_int, jeffs_params, title="Jeff Model Fit Jeff Data")
    ...
    data_over_experiment(cleaned_data_dict, jeffs_params, title="Simple Model Trained on Science Data Predicts Your Experimental Data")

    data_over_experiment(cleaned_data_dict, params_CL, title="Simple Model Trained on Your Experimental Data Predicts Your Experimental Data")
