...
def get_per_cell_sliceTCA_reconstruction_UMAP_contig(model, tensor_for_animal, residual_activity_dict_SST, max_clusters=12, animal_id=1, cell_id=2, display=True):
...
if __name__ == "__main__":
    ...
    internals_dict = get_per_cell_sliceTCA_reconstruction_UMAP_contig(model, tensor_for_animal, residual_activity_dict, max_clusters=5, animal_id=animal_id, cell_id=cell_id, display=False)

    save_dir = fr"/scratch/msf157/data/ca1_data2/EC_model_ranks{ranks}_umap_contig_x00"
