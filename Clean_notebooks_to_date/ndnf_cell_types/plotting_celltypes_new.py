...
"MV228_250922"]
    ...
    print(f"NDNF_model_dict_clean.keys() {NDNF_model_dict_clean.keys()} clean_resid_activity_dict_NDNF_newest.keys() {clean_resid_activity_dict_NDNF_newest.keys()}")
    ...
    plot_cluster_traces_by_animal(labels,
                                clean_resid_activity_dict_NDNF_newest,
                                cells_per_animal_dict,
                                ncol=5, spacing=0.2,
...
# ):
    ...
    plot_cluster_animal_composition_stacked(labels, cells_per_animal_dict, K=2,
    ...
    print(f"w1_subset.shape {w1_subset.shape} f1.shape {f1.shape}")
