...
##############  load your targets and get them into context
...
def compute_features(params, network_seed, model_id=None, export=False, plot=False):
    ...
    pickle_path = context.pickle_path
    animal = params[animal]
    data_root
    num_seeds = context.seed_range

    eval_pickle_cmd(pickle_path, animal, data_root, num_seeds, seed_list, no_plot, weight_dist, plot_file)
