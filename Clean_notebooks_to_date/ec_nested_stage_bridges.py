...
def config_worker():
    ...
    end   = int(context.network_end_seed)      # remember: end-exclusive; use 3 for seeds 0,1,2
...
def get_args():
    context.seed_range = context.seeds_array   # optional
    return [[0]]  # one job; second arg is a dummy
...
def compute_features(params, network_seed, model_id=None, export=False, plot=False):
    ...
    # save_path = "/Users/michaelfinch/CA1-interneuron-GLM/Clean_notebooks_to_date/pickled_model.pkl"
    ...
    # seeds=context.seeds_array,
    # dend_threshold=context.dend_threshold)
