...
if __name__ == "__main__":
    ...
    reconstruction_TCA = model.construct().numpy(force=True)
    internals_dict = get_per_cell_sliceTCA_reconstruction_contig_00x(model, tensor_for_animal, residual_activity_dict, max_clusters=12, animal_id=animal_id, cell_id=cell_id, display=False)

    save_dir = fr"/scratch/msf157/data/ca1_data2/EC_model_ranks{ranks}_regkmeans_x00"
