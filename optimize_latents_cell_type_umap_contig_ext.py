...
if __name__ == "__main__":
    ...
    internals_dict = get_per_cell_sliceTCA_reconstruction_UMAP_contig(model, residual_activity_dict, max_clusters=10, animal_id=animal_id, cell_id=cell_id, display=False)

    save_dir = r"/scratch/msf157/data/CA1-inter/UMAP_contig_NDNF_reconstruct_MSE_data"
    os.makedirs(save_dir, exist_ok=True)  # Ensure directory exists

    save_path = os.path.join(save_dir, f"UMAP_contig_MSE_NDNF_cell_latent_{ranks}_animal{animal_id}_cell_id{cell_id}.pkl")
